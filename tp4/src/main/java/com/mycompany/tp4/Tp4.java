...
public class Tp4 {
    ...
    public static void main(String[] args) {
        ...
        Curso curso1 = new Curso("Base de datos", 8.5, 7.9, 9.2);
        ...
        Profesor profesor2 = new Profesor(87654321, "SQL", programa,curso1, 65432154, "Alberto", "Olmedo", "Calle Corrientes 1000", 800);
